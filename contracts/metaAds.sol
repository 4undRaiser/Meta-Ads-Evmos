...
contract MetaAds is ERC721Enumerable, ERC721URIStorage, Ownable{
    ...
    // Constructor 
    constructor() ERC721("MetaAds", "MTADS") {}
    ...
    */
    ...
    function buySpace(
        ...
        uint _endDate = calculateEndDate(_expiryDate);
    ...
    */
    ...
    /** 
    @dev calculating the endDate of an ad campaign by using block.timestamp as now and
    adding it to the number of days that is passed into the function.
    */
    function calculateEndDate(uint _expiryDate) private view returns(uint) {
        uint endDate = uint(block.timestamp + _expiryDate); 
        return endDate;
    }
