...
const NftList = ({addNFT, getNfts, getAds, buyySpace, EndAdvert, name, address, uploadImage}) => {
  ...
  */
  ...
  const BuySpace = async (index, days, expiryDate, headline, visualLink, adDescription, price) => {
    try {
      setLoading(true);
      await buyySpace(index, days, expiryDate, headline, visualLink, adDescription, price);
